  ...
  return (
    <ProjectDetail
      ...
      links={[
        {
          label: 'GitHub',
          url: 'https://github.com/kouyara/611',
          icon: 'github',
        },
        {
          label: 'Movie',
          url: 'https://drive.google.com/file/d/1eMm5BS8tkSAS8aLUA38qyKNIvZzt-I9-/view?usp=sharing',
          icon: 'video',
        },
        {
          label: 'Slide',
          url: 'https://docs.google.com/presentation/d/1VFFN5E-9LteSE6-K_pASYL-4fUyeI3uW/edit?usp=sharing&ouid=107441685589901808496&rtpof=true&sd=true',
          icon: 'globe',
        },
      ]}
      additionalInfo={
